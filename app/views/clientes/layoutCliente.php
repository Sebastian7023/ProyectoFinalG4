    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top bg-white">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php?controller=Home&action=index">
                ...
                <span class="ms-2 d-none d-lg-inline">PrettyGirl Salon Beauty Salon</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php?controller=Cliente&action=dashboardCliente">
                            <i class="bi bi-speedometer2"></i> Dashboard
                        </a>
                    </li>
                    <?php if (isset($_SESSION['cliente'])): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?controller=Cliente&action=verDatos">
                                <i class="bi bi-people-fill"></i> Datos del cliente
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="d-flex align-items-center ms-auto">
                    <span class="navbar-text me-3">
                        ...
                        Bienvenido, <?= htmlspecialchars($_SESSION['cliente']['fullName'] ?? 'Cliente') ?>                     
                    </span>
                    <a href="index.php?controller=LoginCliente&action=logout" class="btn btn-outline-danger">
