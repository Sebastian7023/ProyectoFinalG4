    ...
    <div class="row quick-actions-row">
        <div class="col-12">
            ...
            <div class="quick-actions-grid">
                <a href="index.php?controller=User&action=crear" class="quick-action-card">
                ...
                <a href="index.php?controller=User&action=gestionarUsuarios" class="quick-action-card">
                    <div class="action-icon">
                        <i class="bi bi-people"></i>
                    </div>
                    <div class="action-content">
                ...
                <a href="?controller=Estilista&action=listar" class="quick-action-card">
                    <div class="action-icon">
                        <i class="bi bi-scissors"></i>
                    </div>
                    <div class="action-content">
