            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php if (isset($_SESSION['usuario']) && $_SESSION['usuario']['rol'] === 'Administrador'): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?controller=ServiceRequest&action=index">
                                <i class="bi bi-people-fill"></i> Servicios
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="d-flex align-items-center ms-auto">
                    <span class="navbar-text me-3">
                        ...
                        Bienvenido, <?= htmlspecialchars($_SESSION['usuario']['fullName'] ?? 'Estilista') ?>
